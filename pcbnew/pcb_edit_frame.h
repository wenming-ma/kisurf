...
class WX_INFOBAR;
class AI_AGENT_PANEL;
class KISURF_AI_PCB_SESSION_APPLY_ADAPTER;
class KISURF_AI_PCB_SESSION_PREVIEW_SERVICE;
class KISURF_AI_PCB_SESSION_SHADOW_SEEDER;
class KISURF_AI_PCB_SESSION_VALIDATION_SERVICE;
class KISURF_AI_PCB_TOOL_STATE_PROVIDER;
...
public:
    ...
    /**
     * @return the name of the wxAuiPaneInfo managing the Agent panel
     */
    static const wxString AgentPaneName() { return wxT( "AgentPanel" ); }
...
private:
    ...
    std::unique_ptr<KISURF_AI_PCB_SESSION_APPLY_ADAPTER> m_aiSessionApplyAdapter;
    std::unique_ptr<KISURF_AI_PCB_SESSION_PREVIEW_SERVICE> m_aiSessionPreviewService;
    std::unique_ptr<KISURF_AI_PCB_SESSION_SHADOW_SEEDER> m_aiSessionShadowSeeder;
    std::unique_ptr<KISURF_AI_PCB_SESSION_VALIDATION_SERVICE> m_aiSessionValidationService;
