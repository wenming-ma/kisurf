# AI PCB Routing Context Coverage Implementation Plan

Date: 2026-06-16

## Checklist

- [x] Add the PCB routing context coverage spec and link it from the AI-native spec index.
- [x] Add RED coverage for visible and selected track/via refs.
- [x] Add RED coverage for resolving track/via refs.
- [x] Implement track/via refs in `KISURF_AI_PCB_CONTEXT_ADAPTER`.
- [x] Implement track/via resolution in `KISURF_AI_PCB_OBJECT_RESOLVER`.
