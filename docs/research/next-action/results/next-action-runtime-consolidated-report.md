...
- 更新：validation facts 已开始投影 `issue_geometry_facts`；这补上了 LLM review 所需的 issue geometry 第一刀，但真实 native validator 仍要继续提供更完整的 issue geometry / affected object / clearance vector / suggested fix facts。
