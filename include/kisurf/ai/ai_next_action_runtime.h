...
inline constexpr unsigned AI_NEXT_ACTION_REPLAY_BATCH_SCHEMA_VERSION = 1;
...
struct KICOMMON_API AI_NEXT_ACTION_REPLAY_GOLDEN_DATASET_EVALUATION_RESULT
{
    ...
    wxString m_TraceValidationIssueKindCountsJson;
    wxString m_TraceValidationIssueSeverityCountsJson;
    wxString m_WorkStateCountsJson;
    wxString m_ErrorCodeCountsJson;
    wxString m_SummaryJson;
};
...
inline constexpr unsigned AI_NEXT_ACTION_REPLAY_GOLDEN_DATASET_SCHEMA_VERSION = 1;
